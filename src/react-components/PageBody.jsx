...
class PageBody extends React.Component {
    ...
    render() {
        const page_detail = this.state.page_library[this.state.page_key];
        return <div>
            <NavigationBar page_title={page_detail.title} />
            <HeroBanner hero_img={page_detail.hero_img} />
            <PageContentFactory component_name={page_detail.content_component_name} page_library={this.state.page_library}/>
            <Footer />
        </div>
    };
}
